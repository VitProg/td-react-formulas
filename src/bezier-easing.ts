...
function createBezierFunc (mX1: number, mY1: number, mX2: number, mY2: number) {
...
export const bezier = (x: number, mX1: number, mY1: number, mX2: number, mY2: number) => createBezierFunc(mX1, mY1, mX2, mY2)(x);

// https://cubic-bezier.com/#1,.5,.95,.67
